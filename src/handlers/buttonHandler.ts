...
import { DUO_BET_INVITE_BUTTON_IDS, handleDuoBetInviteButton } from "../interactions/buttons/duoBetInviteButtons";
...
export async function handleButtonInteraction(interaction: ButtonInteraction): Promise<void> {
  ...
  try {
    ...
    if (Object.values(DUO_BET_INVITE_BUTTON_IDS).includes(baseId as any)) {
      await handleDuoBetInviteButton(interaction);
      return;
    }
